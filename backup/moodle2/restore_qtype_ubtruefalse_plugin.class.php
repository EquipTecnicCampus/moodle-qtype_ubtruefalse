 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_ubtruefalse_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff
        $elename = 'ubtruefalse';
        $elepath = $this->get_pathfor('/ubtruefalse'); // we used get_recommended_name() so this works
     ...
     */
    public function process_ubtruefalse($data) {
        global $DB;
        ...
        if ($questioncreated) {
            ...
            // Insert record
            $newitemid = $DB->insert_record('question_ubtruefalse', $data);
            // Create mapping
            $this->set_mapping('question_ubtruefalse', $oldid, $newitemid);
        }
    }
