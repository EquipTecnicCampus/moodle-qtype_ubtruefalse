...
$string['true'] = 'True';
$string['pluginname'] = 'UB True/False';
$string['pluginname_help'] = 'In response to a question (that may include a image) the respondent chooses from true or false.';
$string['pluginname_link'] = 'question/type/ubtruefalse';
$string['pluginnameadding'] = 'Adding a UB True/False question';
$string['pluginnameediting'] = 'Editing a UB True/False question';
